...
type BeerRequirement struct {
	...
	MinUnits      float32                      `protobuf:"fixed32,3,opt,name=min_units,json=minUnits,proto3" json:"min_units,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *BeerRequirement) GetMinUnits() float32 {
	if x != nil {
		return x.MinUnits
	}
	return 0
...
const file_api_proto_rawDesc = "" +
	...
	"\x05beers\x18\x01 \x03(\v2\x10.beerkellar.BeerR\x05beers\"\xee\x01\n" +
	"\x0fBeerRequirement\x12\x1b\n" +
	"\tmax_units\x18\x01 \x01(\x02R\bmaxUnits\x12D\n" +
	"\bstrategy\x18\x02 \x01(\x0e2(.beerkellar.BeerRequirement.PickStrategyR\bstrategy\x12\x1b\n" +
	"\tmin_units\x18\x03 \x01(\x02R\bminUnits\"[\n" +
