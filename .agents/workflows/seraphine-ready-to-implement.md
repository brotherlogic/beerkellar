...
1. **Write Red Tests:** Write the new unit/integration test(s) first. Run the test command (e.g., `go test -v ./...`) and output the failing ("Red") terminal logs directly in the chat to prove the test is failing.
